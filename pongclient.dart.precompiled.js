...
["Pong", "pongclient.dart", , G, {
  ...
  Ball: {
    ...
    update$3: function(canvas, players, ellapsed) {
      ...
      t2 = t1 + t2 * ellapsed;
      if (!(t2 < 0)) {
        t1 = J.get$height$x(canvas);
        if (typeof t1 !== "number")
          return t1.$sub();
        t1 = t2 > t1 - this._width_height;
      } else
        t1 = true;
      if (t1) {
        t1 = this._decallage_y;
        if (typeof t1 !== "number")
          return t1.$mul();
        this._decallage_y = t1 * -1;
      } else {
        t1 = this._x;
        t2 = this._decallage_x;
        if (typeof t2 !== "number")
        ...
        if (t1 + t2 < 0)
          ...
          if (typeof t3 !== "number")
            return H.iae(t3);
          if (t1 + this._width_height + t2 > t3)
            return 1;
        }
      }
      H.IterableMixinWorkaround_forEach(players, new G.Ball_update_closure(this));
      t1 = this._x;
      this._last_x = t1;
      t2 = this._decallage_x;
      if (typeof t2 !== "number")
        return t2.$mul();
      this._x = t1 + t2 * ellapsed;
      t2 = this._y;
      t1 = this._decallage_y;
      if (typeof t1 !== "number")
        return t1.$mul();
      this._y = t2 + t1 * ellapsed;
      return 0;
    },
    Ball$3: function(_x, _y, _width_height) {
      var t1, t2;
      t1 = C.C__JSRandom.nextInt$1(120) - 60;
      this._decallage_x = t1;
      t1 = C.JSInt_methods.get$isNegative(t1);
      t2 = this._decallage_x;
      if (t1) {
        if (typeof t2 !== "number")
          return t2.$sub();
        this._decallage_x = t2 - 120;
      } else {
        if (typeof t2 !== "number")
          return t2.$add();
        this._decallage_x = t2 + 120;
      }
      t1 = C.C__JSRandom.nextInt$1(40) - 20;
      this._decallage_y = t1;
      t1 = C.JSInt_methods.get$isNegative(t1);
      t2 = this._decallage_y;
      if (t1) {
        if (typeof t2 !== "number")
          return t2.$sub();
        this._decallage_y = t2 - 40;
      } else {
        if (typeof t2 !== "number")
          return t2.$add();
        this._decallage_y = t2 + 40;
      ...
      this.tick_increase_speed = P.Timer_Timer$periodic(P.Duration$(0, 0, 0, 0, 0, 1), new G.Ball_closure(this));
    },
    static: {Ball$: function(_x, _y, _width_height) {
        var t1 = new G.Ball(_x, _y, null, _width_height, null, null, null);
        t1.Ball$3(_x, _y, _width_height);
        return t1;
      }}
  },
  Ball_closure: {
  ...
  Ball_update_closure: {
    ...
    call$1: function(player) {
      ...
      if (t2 < t4 + t5) {
        ...
        t2 = false;
      if (t2)
        if (J.get$isNegative$n(t3._decallage_x)) {
          t2 = t1.get$x(player);
          t4 = t1.get$width(player);
          if (typeof t2 !== "number")
            return t2.$add();
          if (typeof t4 !== "number")
            return H.iae(t4);
  ...
  GFOPTP: {
    "^": "Object;_canvas,_ctx,_play,_players,_ball,_last,_resize_window,_menu,_div_toast",
    _toast$1: function(message) {
      var div_message, t1, replay, t2, back_menu, button_container;
      div_message = document.createElement("div", null);
      t1 = J.getInterceptor$x(div_message);
      t1.get$classes(div_message).add$1(0, "div_message");
      t1.set$innerHtml(div_message, message);
      replay = document.createElement("div", null);
      t1 = J.getInterceptor$x(replay);
      t1.get$classes(replay).add$1(0, "button_toast");
      t2 = t1.get$onClick(replay);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.GFOPTP__toast_closure(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1.set$innerHtml(replay, "Re-play");
      back_menu = document.createElement("div", null);
      t1 = J.getInterceptor$x(back_menu);
      t1.get$classes(back_menu).add$1(0, "button_toast");
      t2 = t1.get$onClick(back_menu);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.GFOPTP__toast_closure0(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1.set$innerHtml(back_menu, "Back to menu");
      button_container = document.createElement("div", null);
      J.get$classes$x(button_container).add$1(0, "button_container");
      button_container.appendChild(replay);
      button_container.appendChild(back_menu);
      t1 = document.createElement("div", null);
      J.get$classes$x(t1).add$1(0, "toast");
      J.set$width$x(t1.style, J.toString$0(window.innerWidth) + "px");
      J.set$height$x(t1.style, J.toString$0(window.innerHeight) + "px");
      J.set$background$x(t1.style, "rgba(0, 0, 0, 0.9)");
      t1.appendChild(div_message);
      t1.appendChild(button_container);
      this._div_toast = t1;
      this._resize_window = C.EventStreamProvider_resize.forTarget$1(window).listen$1(new G.GFOPTP__toast_closure1(this));
      document.body.appendChild(this._div_toast);
    },
    gameLoop$0: function() {
      var now, t1, dt, t2, state, t3, t4;
      ...
      this._ctx.clearRect(0, 0, t2.get$width(t1), t2.get$height(t1));
      H.IterableMixinWorkaround_forEach(this._players, new G.GFOPTP_gameLoop_closure(this, dt));
      state = this._ball.update$3(t1, this._players, dt);
      if (state === 0) {
        t1 = this._ball;
        t2 = this._ctx;
        t2.beginPath();
        t3 = t1._width_height;
        t2.rect(t1._x, t1._y, t3, t3);
        t2.fillStyle = "#fff";
        t2.fill();
      } else if (state === 1) {
        t3 = this._players;
        if (0 >= t3.length)
          return H.ioore(t3, 0);
        ++t3[0].score;
        t3 = document.querySelector("#score_player_1");
        t4 = this._players;
        if (0 >= t4.length)
          return H.ioore(t4, 0);
        J.set$innerHtml$x(t3, C.JSInt_methods.toString$0(t4[0].score));
        this._ball.tick_increase_speed.cancel$0();
        t4 = t2.get$width(t1);
        if (typeof t4 !== "number")
          return t4.$div();
        t1 = t2.get$height(t1);
        if (typeof t1 !== "number")
          return t1.$div();
        this._ball = G.Ball$(t4 / 2, t1 / 2, 10);
        t1 = this._players;
        if (0 >= t1.length)
          return H.ioore(t1, 0);
        if (t1[0].score === 10) {
          this._toast$1("Player 1 win !");
          this._play = false;
        }
      } else if (state === 2) {
        t3 = this._players;
        if (1 >= t3.length)
          return H.ioore(t3, 1);
        ++t3[1].score;
        t3 = document.querySelector("#score_player_2");
        t4 = this._players;
        if (1 >= t4.length)
          return H.ioore(t4, 1);
        J.set$innerHtml$x(t3, C.JSInt_methods.toString$0(t4[1].score));
        this._ball.tick_increase_speed.cancel$0();
        t4 = t2.get$width(t1);
        if (typeof t4 !== "number")
          return t4.$div();
      ...
      if (this._play) {
        ...
        C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(new G.GFOPTP_gameLoop_closure0(this)));
      }
    },
    GFOPTP$2: function(_menu, _canvas) {
      var t1, t2, t3;
      P.print("GFOPTP contructor");
      t1 = this._canvas;
      this._ctx = J.get$context2D$x(t1);
      this._play = false;
      t2 = H.setRuntimeTypeInfo([], [G.Player]);
      this._players = t2;
      t3 = t1.height;
      if (typeof t3 !== "number")
        return t3.$div();
      t3 = new G.Player(1, 10, t3 / 2 - 30, null, 60, null, null);
      t3.width = 10;
      t3.score = 0;
      t2.push(t3);
      t3 = this._players;
      ...
      if (typeof t2 !== "number")
        return t2.$div();
      t2 = new G.Player(2, 780, t2 / 2 - 30, null, 60, null, null);
      t2.width = 10;
      t2.score = 0;
      t3.push(t2);
      t2 = t1.width;
      ...
      if (typeof t1 !== "number")
        return t1.$div();
      this._ball = G.Ball$(t2 / 2, t1 / 2, 10);
      this._last = window.performance.now();
      C.EventStreamProvider_keydown.forTarget$1(window).listen$1(new G.GFOPTP_closure(this));
      C.EventStreamProvider_keyup.forTarget$1(window).listen$1(new G.GFOPTP_closure0(this));
      this.gameLoop$0();
    },
    static: {GFOPTP$: function(_menu, _canvas) {
        var t1 = new G.GFOPTP(_canvas, null, null, null, null, null, null, _menu, null);
        t1.GFOPTP$2(_menu, _canvas);
        return t1;
      }}
  },
  GFOPTP_closure: {
    "^": "Closure:12;this_0",
    call$1: function(keyboard_event) {
      var t1, t2, player1, player2;
      t1 = this.this_0._players;
      t2 = t1.length;
      if (0 >= t2)
        return H.ioore(t1, 0);
      player1 = t1[0];
      if (1 >= t2)
        return H.ioore(t1, 1);
      player2 = t1[1];
      if (J.get$keyCode$x(keyboard_event) === 87)
        player1.up_down = -1;
      else if (keyboard_event.keyCode === 83)
        player1.up_down = 1;
      t1 = keyboard_event.keyCode;
      if (t1 === 38)
        player2.up_down = -1;
      else if (t1 === 40)
        player2.up_down = 1;
  ...
  GFOPTP_closure0: {
    ...
    call$1: function(keyboard_event) {
      ...
      if (1 >= t3)
        return H.ioore(t2, 1);
      player2 = t2[1];
      if (J.get$keyCode$x(keyboard_event) === 87 || keyboard_event.keyCode === 83)
        player1.up_down = 0;
      t2 = keyboard_event.keyCode;
      if (t2 === 40 || t2 === 38)
        player2.up_down = 0;
  ...
  GFOPTP__toast_closure: {
    "^": "Closure:13;this_0",
    call$1: function(mouse_event) {
      var t1, t2, t3, t4;
      P.print("replay");
      t1 = this.this_0;
      J.remove$0$ax(t1._div_toast);
      t1._ball.tick_increase_speed.cancel$0();
      t2 = t1._canvas;
      ...
      if (typeof t2 !== "number")
        return t2.$div();
      t1._ball = G.Ball$(t4 / 2, t2 / 2, 10);
      H.IterableMixinWorkaround_forEach(t1._players, new G.GFOPTP__toast__closure());
      t2 = document.querySelector("#score_player_1");
      t4 = t1._players;
      if (0 >= t4.length)
        return H.ioore(t4, 0);
      J.set$innerHtml$x(t2, C.JSInt_methods.toString$0(t4[0].score));
      t4 = document.querySelector("#score_player_2");
      t2 = t1._players;
      if (1 >= t2.length)
        return H.ioore(t2, 1);
      J.set$innerHtml$x(t4, C.JSInt_methods.toString$0(t2[1].score));
      t1._last = window.performance.now();
      t1.gameLoop$0();
    }
  },
  GFOPTP__toast__closure: {
    "^": "Closure:11;",
    call$1: function(player) {
      player.set$score(0);
    }
  },
  GFOPTP__toast_closure0: {
    "^": "Closure:13;this_1",
    call$1: function(mouse_event) {
      var t1;
      P.print("back to menu");
      J.set$innerHtml$x(document.querySelector("#container"), "");
      window.localStorage.setItem($.Menu_GAME_STATE, $.Menu_IN_MENU);
      t1 = this.this_1;
      J.remove$0$ax(t1._div_toast);
      t1._menu._startInMenu$0();
    }
  },
  GFOPTP__toast_closure1: {
    "^": "Closure:14;this_2",
    call$1: function($event) {
      var t1 = this.this_2._div_toast;
      J.set$width$x(t1.style, J.toString$0(window.innerWidth) + "px");
      J.set$height$x(t1.style, J.toString$0(window.innerHeight) + "px");
    }
  },
  GFOPTP_gameLoop_closure: {
    "^": "Closure:11;this_0,dt_1",
    call$1: function(object) {
      var t1 = this.this_0;
      object.update$2(t1._canvas, this.dt_1);
      t1 = t1._ctx;
      t1.fillStyle = "#fff";
      t1.beginPath();
      t1.rect(object.x, object.y, object.width, object.height);
      t1.fillStyle = "#fff";
      t1.fill();
    }
  },
  GFOPTP_gameLoop_closure0: {
    "^": "Closure:15;this_2",
    call$1: function(ellapsed) {
      return this.this_2.gameLoop$0();
    }
  },
  Menu: {
    "^": "Object;_initialisation_function",
    _startInMenu$0: [function() {
      var flex, one, t1, two;
      P.print("start in menu");
      flex = document.createElement("div", null);
      J.get$classes$x(flex).add$1(0, "flex");
      one = document.createElement("div", null);
      one.setAttribute("id", "one");
      t1 = J.getInterceptor$x(one);
      t1.get$classes(one).add$1(0, "playbutton");
      t1.set$innerHtml(one, "One Player One Pc");
      t1 = t1.get$onClick(one);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.Menu__startInMenu_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      two = document.createElement("div", null);
      two.setAttribute("id", "two");
      t1 = J.getInterceptor$x(two);
      t1.get$classes(two).add$1(0, "playbutton");
      t1.set$innerHtml(two, "Two Player One Pc");
      t1 = t1.get$onClick(two);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.Menu__startInMenu_closure0(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      flex.appendChild(two);
      document.querySelector("#container").appendChild(flex);
    }, "call$0", "get$_startInMenu", 0, 0, 0],
    _startInGameOne$0: [function() {
      var all_scores, t1, player1, player2, text_scores, score_player1, score_player2, scores, canvas;
      P.print("start in game one");
      all_scores = document.createElement("div", null);
      t1 = J.getInterceptor$x(all_scores);
      t1.get$classes(all_scores).add$1(0, "all_scores");
      t1.set$innerHtml(all_scores, "Scores :");
      player1 = document.createElement("div", null);
      t1 = J.getInterceptor$x(player1);
      t1.get$classes(player1).add$1(0, "player1");
      t1.set$innerHtml(player1, "Player 1 :");
      player2 = document.createElement("div", null);
      t1 = J.getInterceptor$x(player2);
      t1.get$classes(player2).add$1(0, "player2");
      t1.set$innerHtml(player2, "Player 2 :");
      text_scores = document.createElement("div", null);
      J.get$classes$x(text_scores).add$1(0, "text_scores");
      text_scores.appendChild(player1);
      text_scores.appendChild(player2);
      score_player1 = document.createElement("div", null);
      t1 = J.getInterceptor$x(score_player1);
      t1.get$classes(score_player1).add$1(0, "scoreplayer1");
      score_player1.setAttribute("id", "score_player_1");
      t1.set$innerHtml(score_player1, "0");
      score_player2 = document.createElement("div", null);
      t1 = J.getInterceptor$x(score_player2);
      t1.get$classes(score_player2).add$1(0, "scoreplayer2");
      score_player2.setAttribute("id", "score_player_2");
      t1.set$innerHtml(score_player2, "0");
      scores = document.createElement("div", null);
      J.get$classes$x(scores).add$1(0, "scores");
      scores.appendChild(score_player1);
      scores.appendChild(score_player2);
      canvas = W.CanvasElement_CanvasElement(600, 800);
      J.get$classes$x(canvas).add$1(0, "canvas");
      t1 = document.querySelector("#container");
      t1.appendChild(all_scores);
      t1.appendChild(text_scores);
      t1.appendChild(scores);
      t1.appendChild(canvas);
    }, "call$0", "get$_startInGameOne", 0, 0, 0],
    _startInGameTwo$0: [function() {
      var all_scores, t1, player1, player2, text_scores, score_player1, score_player2, scores, canvas;
      P.print("start in game two");
      all_scores = document.createElement("div", null);
      t1 = J.getInterceptor$x(all_scores);
      t1.get$classes(all_scores).add$1(0, "all_scores");
      t1.set$innerHtml(all_scores, "Scores :");
      ...
      t1.appendChild(scores);
      t1.appendChild(canvas);
      G.GFOPTP$(this, canvas);
    }, "call$0", "get$_startInGameTwo", 0, 0, 0],
    Menu$0: function() {
      var t1, t2;
      t1 = P.LinkedHashMap_LinkedHashMap$_empty(P.String, P.Function);
      this._initialisation_function = t1;
      t1.$indexSet(0, $.Menu_IN_MENU, this.get$_startInMenu());
      this._initialisation_function.$indexSet(0, $.Menu_IN_GAME_ONE, this.get$_startInGameOne());
      this._initialisation_function.$indexSet(0, $.Menu_IN_GAME_TWO, this.get$_startInGameTwo());
      if (window.localStorage.getItem($.Menu_GAME_STATE) != null) {
        t1 = this._initialisation_function.containsKey$1(0, window.localStorage.getItem($.Menu_GAME_STATE));
        t2 = this._initialisation_function;
        if (t1)
          t2.$index(0, window.localStorage.getItem($.Menu_GAME_STATE)).call$0();
        else
          t2.$index(0, $.Menu_IN_MENU).call$0();
      } else
        this._initialisation_function.$index(0, $.Menu_IN_MENU).call$0();
      C._BeforeUnloadEventStreamProvider_beforeunload.forTarget$1(window).listen$1(new G.Menu_closure());
    },
    static: {"^": "Menu_GAME_STATE,Menu_IN_MENU,Menu_IN_GAME_ONE,Menu_IN_GAME_TWO", Menu$: function() {
        var t1 = new G.Menu(null);
        t1.Menu$0();
        return t1;
      }}
  },
  ...
  Menu__startInMenu_closure: {
    "^": "Closure:13;",
    call$1: function(mouse_event) {
      P.print("Not supported yet");
    }
  },
  Menu__startInMenu_closure0: {
    "^": "Closure:13;this_0",
    call$1: function(mouse_event) {
      J.set$innerHtml$x(document.querySelector("#container"), "");
      this.this_0._startInGameTwo$0();
      window.localStorage.setItem($.Menu_GAME_STATE, $.Menu_IN_GAME_TWO);
    }
  },
  Player: {
    "^": "Object;_Pong$_id,x>,y>,width>,height>,score?,up_down",
    update$2: function(canvas, ellapsed) {
      var t1, t2, t3, t4, t5;
      t1 = this.up_down;
      if (t1 === 1) {
        t1 = this.y;
        t2 = this.height;
        t3 = 100 * ellapsed;
        t4 = J.getInterceptor$x(canvas);
        t5 = t4.get$height(canvas);
        if (typeof t5 !== "number")
          return H.iae(t5);
        if (t1 + t2 + t3 < t5)
          this.y += t3;
        else {
          t1 = t4.get$height(canvas);
          t2 = this.height;
          if (typeof t1 !== "number")
            return t1.$sub();
          this.y = t1 - t2;
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "CanvasGradient|CanvasPattern|CanvasRenderingContext|CanvasRenderingContext2D|DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["dart.collection", "dart:collection", , P, {
  ...
  _LinkedHashMap: {
    "^": "Object;_collection$_length,_strings,_nums,_rest,_first,_collection$_last,_modifications",
    get$length: function(_) {
      return this._collection$_length;
    },
    get$isEmpty: function(_) {
  ...
  _LinkedHashSet: {
    "^": "_HashSetBase;_collection$_length,_strings,_nums,_rest,_first,_collection$_last,_modifications",
    get$iterator: function(_) {
...
$.libraries_to_load = {};
$.Menu_GAME_STATE = "GAME_STATE";
$.Menu_IN_MENU = "IN_MENU";
$.Menu_IN_GAME_ONE = "IN_GAME_ONE";
$.Menu_IN_GAME_TWO = "IN_GAME_TWO";
...
{func: "dynamic__Player", args: [G.Player]},
...
function dart_precompiled($collectedClasses) {
  ...
  function Ball(_x, _y, _last_x, _width_height, _decallage_x, _decallage_y, tick_increase_speed) {
    this._x = _x;
    this._y = _y;
    this._last_x = _last_x;
    this._width_height = _width_height;
    this._decallage_x = _decallage_x;
    this._decallage_y = _decallage_y;
    this.tick_increase_speed = tick_increase_speed;
  }
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Ball.prototype = $desc;
  function Ball_closure(this_0) {
    this.this_0 = this_0;
  }
  Ball_closure.builtin$cls = "Ball_closure";
  if (!"name" in Ball_closure)
    Ball_closure.name = "Ball_closure";
  $desc = $collectedClasses.Ball_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Ball_closure.prototype = $desc;
  function Ball_update_closure(this_0) {
    this.this_0 = this_0;
  }
  Ball_update_closure.builtin$cls = "Ball_update_closure";
  if (!"name" in Ball_update_closure)
    Ball_update_closure.name = "Ball_update_closure";
  $desc = $collectedClasses.Ball_update_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Ball_update_closure.prototype = $desc;
  function GFOPTP(_canvas, _ctx, _play, _players, _ball, _last, _resize_window, _menu, _div_toast) {
    ...
    this._ball = _ball;
    this._last = _last;
    this._resize_window = _resize_window;
    this._menu = _menu;
    this._div_toast = _div_toast;
  }
  GFOPTP.builtin$cls = "GFOPTP";
  if (!"name" in GFOPTP)
    GFOPTP.name = "GFOPTP";
  $desc = $collectedClasses.GFOPTP;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GFOPTP.prototype = $desc;
  function GFOPTP_closure(this_0) {
    this.this_0 = this_0;
  }
  GFOPTP_closure.builtin$cls = "GFOPTP_closure";
  if (!"name" in GFOPTP_closure)
    GFOPTP_closure.name = "GFOPTP_closure";
  $desc = $collectedClasses.GFOPTP_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GFOPTP_closure.prototype = $desc;
  function GFOPTP_closure0(this_1) {
    this.this_1 = this_1;
  }
  GFOPTP_closure0.builtin$cls = "GFOPTP_closure0";
  if (!"name" in GFOPTP_closure0)
    GFOPTP_closure0.name = "GFOPTP_closure0";
  $desc = $collectedClasses.GFOPTP_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GFOPTP_closure0.prototype = $desc;
  function GFOPTP__closure(this_2) {
    this.this_2 = this_2;
  }
  GFOPTP__closure.builtin$cls = "GFOPTP__closure";
  if (!"name" in GFOPTP__closure)
    GFOPTP__closure.name = "GFOPTP__closure";
  $desc = $collectedClasses.GFOPTP__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GFOPTP__closure.prototype = $desc;
  function GFOPTP__toast_closure(this_0) {
    this.this_0 = this_0;
  }
  GFOPTP__toast_closure.builtin$cls = "GFOPTP__toast_closure";
  if (!"name" in GFOPTP__toast_closure)
    GFOPTP__toast_closure.name = "GFOPTP__toast_closure";
  $desc = $collectedClasses.GFOPTP__toast_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GFOPTP__toast_closure.prototype = $desc;
  function GFOPTP__toast__closure() {
  }
  GFOPTP__toast__closure.builtin$cls = "GFOPTP__toast__closure";
  if (!"name" in GFOPTP__toast__closure)
    GFOPTP__toast__closure.name = "GFOPTP__toast__closure";
  $desc = $collectedClasses.GFOPTP__toast__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GFOPTP__toast__closure.prototype = $desc;
  function GFOPTP__toast_closure0(this_1) {
    this.this_1 = this_1;
  }
  GFOPTP__toast_closure0.builtin$cls = "GFOPTP__toast_closure0";
  if (!"name" in GFOPTP__toast_closure0)
    GFOPTP__toast_closure0.name = "GFOPTP__toast_closure0";
  $desc = $collectedClasses.GFOPTP__toast_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GFOPTP__toast_closure0.prototype = $desc;
  function GFOPTP__toast_closure1(this_2) {
    this.this_2 = this_2;
  }
  GFOPTP__toast_closure1.builtin$cls = "GFOPTP__toast_closure1";
  if (!"name" in GFOPTP__toast_closure1)
    GFOPTP__toast_closure1.name = "GFOPTP__toast_closure1";
  $desc = $collectedClasses.GFOPTP__toast_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GFOPTP__toast_closure1.prototype = $desc;
  function GFOPTP_gameLoop_closure(this_0, dt_1) {
    this.this_0 = this_0;
    this.dt_1 = dt_1;
  }
  GFOPTP_gameLoop_closure.builtin$cls = "GFOPTP_gameLoop_closure";
  if (!"name" in GFOPTP_gameLoop_closure)
    GFOPTP_gameLoop_closure.name = "GFOPTP_gameLoop_closure";
  $desc = $collectedClasses.GFOPTP_gameLoop_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GFOPTP_gameLoop_closure.prototype = $desc;
  function GFOPTP_gameLoop_closure0(this_2) {
    this.this_2 = this_2;
  }
  GFOPTP_gameLoop_closure0.builtin$cls = "GFOPTP_gameLoop_closure0";
  if (!"name" in GFOPTP_gameLoop_closure0)
    GFOPTP_gameLoop_closure0.name = "GFOPTP_gameLoop_closure0";
  $desc = $collectedClasses.GFOPTP_gameLoop_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GFOPTP_gameLoop_closure0.prototype = $desc;
  function Menu(_initialisation_function) {
    this._initialisation_function = _initialisation_function;
  }
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Menu.prototype = $desc;
  function Menu_closure() {
  }
  Menu_closure.builtin$cls = "Menu_closure";
  if (!"name" in Menu_closure)
    Menu_closure.name = "Menu_closure";
  $desc = $collectedClasses.Menu_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Menu_closure.prototype = $desc;
  function Menu__startInMenu_closure() {
  }
  Menu__startInMenu_closure.builtin$cls = "Menu__startInMenu_closure";
  if (!"name" in Menu__startInMenu_closure)
    Menu__startInMenu_closure.name = "Menu__startInMenu_closure";
  $desc = $collectedClasses.Menu__startInMenu_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Menu__startInMenu_closure.prototype = $desc;
  function Menu__startInMenu_closure0(this_0) {
    this.this_0 = this_0;
  }
  Menu__startInMenu_closure0.builtin$cls = "Menu__startInMenu_closure0";
  if (!"name" in Menu__startInMenu_closure0)
    Menu__startInMenu_closure0.name = "Menu__startInMenu_closure0";
  $desc = $collectedClasses.Menu__startInMenu_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Menu__startInMenu_closure0.prototype = $desc;
  function Player(_Pong$_id, x, y, width, height, score, up_down) {
    this._Pong$_id = _Pong$_id;
    this.x = x;
    this.y = y;
    this.width = width;
    this.height = height;
  ...
  Player.prototype.get$x = function(receiver) {
    return this.x;
  };
  Player.prototype.get$y = function(receiver) {
    return this.y;
  };
  ...
  Player.prototype.set$score = function(v) {
    return this.score = v;
  };
  ...
  function _LinkedHashMap(_collection$_length, _strings, _nums, _rest, _first, _collection$_last, _modifications) {
    this._collection$_length = _collection$_length;
    this._strings = _strings;
    this._nums = _nums;
    this._rest = _rest;
  ...
  function _LinkedHashSet(_collection$_length, _strings, _nums, _rest, _first, _collection$_last, _modifications) {
    this._collection$_length = _collection$_length;
    this._strings = _strings;
    this._nums = _nums;
    this._rest = _rest;
