...
["", "pongclient.dart", , R, {
  ...
  main: [function() {
    var ws, t1;
    P.print("ok we are in the game !!");
    ws = W.WebSocket_WebSocket("ws://127.0.0.1:8889/ws", null);
    t1 = H.setRuntimeTypeInfo(new W._EventStream(ws, C.EventStreamProvider_open._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.main_closure(ws)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.setRuntimeTypeInfo(new W._EventStream(ws, C.EventStreamProvider_message._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.main_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.setRuntimeTypeInfo(new W._EventStream(ws, C.EventStreamProvider_close._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.main_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.setRuntimeTypeInfo(new W._EventStream(ws, C.EventStreamProvider_error._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.main_closure2()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 1],
  main_closure: {
    "^": "Closure:21;ws_0",
    call$1: function($event) {
      P.print("Open WebSocket");
      this.ws_0.send("TEST");
    }
  },
  main_closure0: {
    "^": "Closure:22;",
    call$1: function(message_event) {
      P.print("Message WebSocket");
      P.print(J.get$data$x(message_event));
    }
  },
  main_closure1: {
    "^": "Closure:23;",
    call$1: function(close_event) {
      P.print("Close WebScoket");
    }
  },
  main_closure2: {
    "^": "Closure:21;",
    call$1: function($event) {
      P.print("Error WebSocket");
    }
  }
},
1],
